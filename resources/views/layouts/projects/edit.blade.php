...
<hr />
    ...
    <div class="form-group has-feedback">
        <input name="name" id="nameForm" class="form-control" placeholder="Nazwa">
	  ...
	  <span class="fa fa-pencil form-control-feedback"></span>
		<textarea name="description" id="descriptionForm" class="form-control" rows="3" 
			placeholder="Opis..." dir="ltr" style="margin: 0px -7px 0px 0px;  min-width:100%; max-width:100%; min-height: 100px; max-height:200px;"></textarea>        
    </div>
